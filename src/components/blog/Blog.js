				...
				<div className="blog-detail-ct">
					...
					<div className="flex-it share-tag">
						<div className="social-link">
							<h4>Share it</h4>
							<Link ><i className="ion-social-facebook"></i></Link>
							<Link ><i className="ion-social-twitter"></i></Link>
							<Link ><i className="ion-social-googleplus"></i></Link>
							<Link ><i className="ion-social-pinterest"></i></Link>
							<Link ><i className="ion-social-linkedin"></i></Link>
						</div>
					...
					<div className="comments">
						...
						<div className="cmt-item flex-it reply">
							...
							<div className="author-infor">
								<div className="flex-it2">
									<h6><Link >Dave McNary</Link></h6> <span className="time"> - 27 Mar 2017</span>
								</div>
						...
						<div className="cmt-item flex-it">
							...
							<div className="author-infor">
								<div className="flex-it2">
									<h6><Link >Margot Robbie</Link></h6> <span className="time"> - 27 Mar 2017</span>
								</div>
								...
								<p><Link className="rep-btn" >+ Reply</Link></p>
							</div>
						</div>
					</div>
